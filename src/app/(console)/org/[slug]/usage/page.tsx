...
import { mockBuildLogs, mockBuilders } from '@/lib/mock-data'
  ...
  return (
    <div className="flex flex-col h-full">
      <Header 
        ...
        subtitle={`Build activity for ${org.name}`}
      />
              ...
              <div key={builder.id}>
                ...
                <div className="h-2 overflow-hidden rounded-full bg-slate-800">
                  <div
                    ...
                    style={{ width: `${org.totalMinutes ? (builder.totalMinutes / org.totalMinutes) * 100 : 0}%` }}
                  />
                </div>
              </div>
            ))}
